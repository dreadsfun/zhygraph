...
A szkript elsõ részében importáljuk a szükséges modulokat a keretrendszer saját csomagjából (py\_api). Ezek a kamerastruktúrát leíró csúcs-osztály (camera\_node), a felhasználói bemenet kezelésére szolgáló osztályok és értékek (input, keys, buttons), a transzformációkhoz szükséges osztályok (transform, coordinate\_space) valamint egy három-dimenziós vektor struktúra.
